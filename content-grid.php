        ...
        <div class="post-details">
            <div class="post-details-holder">
                ...
                <div class="post-category-comment-date row">
                    ...
                    <!-- POST COMMENTS -->
                    <span class="meta-pipe">|</span>
                    <span class="post-comments"><i class="icon-bubbles icons"></i><a href="<?php echo the_permalink().'#comments'; ?>"><?php comments_number( '0' . esc_attr__(' Comments','medpluswp'), '1' . esc_html__(' Comment','medpluswp'), '%' . esc_attr__(' Comments','medpluswp') ); ?></a></span>
