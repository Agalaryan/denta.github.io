                ...
                <div class="article-content row">
                    ...
                    <div class="portfolio-bottom-icons clearfix">
                        <ul class="text-center">
                            <h4 class="single-post-love"><?php echo medpluswp_li_love_link($love_text = null, $loved_text = null); ?></h4>
                        </ul>
                    </div>
                    ...
                    <div class="portfolio-bottom-description">
                        ...
                        <div class="col-md-4">
                            <h3 class="post-name"><?php echo esc_attr__('Project Details ','medpluswp'); ?></h3>
                            <p><i class="icon-calendar"></i> <label><?php echo esc_html__('Completed:','medpluswp'); ?></label><?php echo get_the_date(get_option( 'date_format' )); ?></p>
                            <p>
                                <i class="icon-user"></i>
                                <label><?php echo esc_html__('Client:','medpluswp'); ?></label> <?php echo get_post_meta( get_the_ID(), 'smartowl_client_name', true ); ?>
                            </p>
                            <p>
                                <i class="icon-tag"></i>
                            ...
                            <p><i class="icon-link"></i> <label><?php echo esc_html__('Live demo:','medpluswp'); ?></label> <a href="<?php echo esc_url($project_link); ?>">View Demo</a></p>
                        </div>
                    </div>

                    <?php if ( medpluswp_redux('mt_enable_post_navigation') ) { ?>
