...
function medpluswp_custom_comments($comment, $args, $depth) {
...
?>
    ...
    <div id="div-comment-<?php comment_ID() ?>" class="comment-body fullwidth single_comment parent row">
        <?php endif; ?>
            <div class="comment-author vcard comment_author vc_col-md-1">
                <?php if ( $args['avatar_size'] != 0 ) echo get_avatar( $comment, 130 ); ?>
            </div>
        <?php if ( $comment->comment_approved == '0' ) : ?>
            <em class="comment-awaiting-moderation"><?php esc_attr_e( 'Your comment is awaiting moderation.','medpluswp' ); ?></em>
        <?php endif; ?>
        ...
        <div class="comment-meta commentmetadata vc_col-md-11 comment_body relative">
            ...
            <span class="reply_button1 col-md-3 text-left">
                <?php edit_comment_link( esc_attr__( 'Edit', 'medpluswp' ), '  ', '' ); ?>
