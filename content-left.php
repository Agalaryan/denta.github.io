            ...
            <div class="post-details-holder">
                <h3 class="post-name row">
                    <a title="<?php the_title_attribute() ?>" href="<?php the_permalink(); ?>">
                        <?php echo  wp_kses_post($sticky_status); ?>
                        <?php the_title() ?>
                    </a>
                </h3>
                ...
                <div class="post-category-comment-date row">
                    ...
                    <!-- POST AUTHOR -->
                    <span class="post-author"><?php echo esc_attr__( 'By', 'medpluswp' ); ?> <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ), get_the_author_meta( 'user_nicename' ) ); ?>"><?php echo get_the_author(); ?></a></span>
                    ...
                    <!-- POST COMMENTS -->
                    <span class="meta-pipe">|</span>
                    <span class="post-comments"><i class="icon-bubbles icons"></i> <a href="<?php echo the_permalink().'#comments'; ?>"><?php comments_number( '0' . esc_attr__(' Comments','medpluswp'), '1' . esc_attr__(' Comment','medpluswp'), '%' . esc_html__(' Comments','medpluswp') ); ?></a></span>
